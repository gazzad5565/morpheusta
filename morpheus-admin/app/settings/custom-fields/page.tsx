...
/**
 * /settings/custom-fields — list every defined custom field grouped by
 * entity, with edit + delete inline. "+ New field" CTA lives in the
 * right-of-header actions slot.
 *

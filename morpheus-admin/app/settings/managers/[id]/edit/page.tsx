...
export default function EditManagerPage({
  ...
  if (loading) {
    return (
      <AdminShell breadcrumbs={["Home", "Settings", "Manage users", "…"]}>
  ...
  if (notFound || !profile) {
    return (
      <AdminShell breadcrumbs={["Home", "Settings", "Manage users", "Not found"]}>
  ...
  return (
    <AdminShell
      breadcrumbs={["Home", "Settings", "Manage users", { label: displayName(profile) }]}
      actions={
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <Card padding={20}>
            ...
            <Field label="Hire date">
              ...
              >
                When this person joined the field workforce. Distinct from the
                account-creation date above.
              </div>
            </Field>
          </Card>
